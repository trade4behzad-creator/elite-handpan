        ...
        return (
          ...
          >
            <Link
              ...
              className="group block bg-white border border-gray-200 hover:border-[#3F3E7A]/60 transition-all duration-300 rounded-[4px] overflow-hidden cursor-pointer p-6"
            >
