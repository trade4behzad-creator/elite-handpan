...
export default function EditInstagramPostForm({
  post,
}: {
  post: { id: string; post_url: string; order: number; image_url: string }
}) {
  ...
  return (
    <div>
      <div style={{ marginBottom: '40px' }}>
        ...
        <h1 style={{ fontSize: '28px', fontWeight: '300', color: '#f5f5f5', margin: 0 }}>ویرایش پست</h1>
        <div style={{ width: '40px', height: '1px', background: GOLD, marginTop: '16px', opacity: 0.5 }} />
      </div>

      <form action={updateInstagramPost}>
        ...
        >
          ...
          <div style={fieldStyle}>
            <label style={labelStyle}>تامبنیل پست (خالی بذار اگه نمی‌خوای عوضش کنی)</label>
            <div
              style={{
            ...
            >
              ...
              <div>
                ...
                />
                {!preview && (
                  <p style={{ fontSize: '11px', color: '#666', marginTop: '8px' }}>عکس فعلی</p>
                )}
              </div>
            </div>
          </div>
